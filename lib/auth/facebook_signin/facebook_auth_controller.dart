...
class FaceBookAuthController extends GetxController {
  ...
  /// Note: Don't forget to add email permission from facebook console like Use cases -> Authentication and account creation -> tap on Edit -> add permission for email
  /// you only able to log in when your admin account/ tester account / developer account of facebook console same log in your device facebook app loggedIn else your not able to login
